  ...
  render() {
    return (
      <div className="main-container pt-3">
        ...
        <div className="spacer" data-desktop="80" data-mobi="60" data-smobi="60"></div>
          <Row>
            <Col md={6} className="videoHeight">
              <h2>
                Aussie Digital Tenders and Contracts Management
              </h2>
            ...
            <Col md={6} className="videoHeight">
              <ReactPlayer url="https://www.youtube.com/watch?v=ap9PvIr9RTg" />
            </Col>
          </Row>
          <div className="spacer" data-desktop="80" data-mobi="60" data-smobi="60"></div>
        </div>
