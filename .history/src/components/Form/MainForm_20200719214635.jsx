      ...
      <div className="container-fluid">
        <Form>
          ...
          <Form.Group as={Row} controlId="formPlaintextPassword">
            ...
            <Col sm="4">
              <Form.Control type="Tender Code" name='code' placeholder="Tender Code" onChange={this.HandleInputChange}/>
            </Col>
          </Form.Group>
          ...
          <div className="btnPosition">
            <Button as="input" icon="Search" type="submit" value="Submit" onClick = {this.submitHandler}/>{" "}
