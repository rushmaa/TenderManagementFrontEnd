  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route exact path="/contracts/awared" component={Newthisweek} />
        <Route exact path="/contracts/across-gov-contracts" component={Newthisweek} />

        <Route exact path="/search/tenders" component={Newthisweek} />
        <Route exact path="/search/contracts" component={Newthisweek} />
