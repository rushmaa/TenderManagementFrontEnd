        ...
        <div style={{ width: '100rem' }}>
            <div class="container float-left pt-1 pb-1">
              ...
              <div class="row justify-content-md-left">
                ...
                <div class="col-md-auto">
                  <p class="font-weight-light">Medical Equipment and Accessories and Supplies - (20%)</p>
                  <p class="font-weight-light">Management and Business Professionals and Administrative Services - (80%)</p>
                </div>
              </div>
            </div>
          </div>
