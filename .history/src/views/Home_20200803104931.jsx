  ...
  render() {
    return (
      <div className="main-container pt-3">
        ...
        <div class="container">
                                <div class="themesflat-spacer clearfix" data-desktop="104" data-mobi="60" data-smobi="60" style="height:104px"></div>
                                    ...
                                    <div class="col-md-6" style="height: 387px;">
                                       <div class="themesflat-spacer clearfix" data-desktop="33" data-mobi="0" data-smobi="0" style="height:33px"></div>
                                        ...
                                        <div class="themesflat-headings style-1 clearfix">
                                            <h2 class="heading letter-spacing--09px clearfix">WE HAVE A WIDE BREADTH OF EXPERIENCE</h2>
                                            <div class="sep clearfix"></div>
                                            <p class="sub-heading clearfix">The breadth of knowledge and experience at Financial Group assures our clients that we have the skills necessary to focus on their important financial matters.</p>
                                ...
                                <div class="themesflat-spacer clearfix" data-desktop="80" data-mobi="60" data-smobi="60" style="height:80px"></div>
