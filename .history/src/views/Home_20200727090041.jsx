    ...
    return (
      <div className="main-container pt-3">
        <div className="container-fluid">
          ...
          />
          <p className="pt-3">
            Welcome to the South Australian Tenders & Contracts website. The
            site provides easy-to-use access to all publicly available bidding
            opportunities within the South Australian Government. Electronic
            submissions can be made using the Electronic Lodgement Service. You
            can also view the details of all South Australian Government-awarded
            contracts for goods, services and works.
          </p>
          <Title header="Electronic Notification" />
          <p>
            If you are a registered member with SA Tenders & Contracts, you can
          ...
          <div>
            <p className="displayInline">
              The site is designed for the publication of all South Australian
          ...
          <div>
            <p className="displayInline">
              ...
              LGA on (08) 8224 2000, OR contact SA Tenders & Contracts Helpdesk
          ...
          <div>
            <p className="displayInline">
              ...
              South Australian Public Sector as required by the DPC Circular
              PC027 'Disclosure of Government Contracts'. To submit a contract
              for publication to the site download the attached document,
              complete the details as requested on the form and return it to SA
              Tenders & Contracts.{" "}
            </p>
