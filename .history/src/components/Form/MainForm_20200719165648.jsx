...
class MainForm extends React.Component {
  const searchCategary = TenderTableData.forEach((element) => {}
  return (
    <div className="pt-3">
      <div className="container-fluid">
        <Form>
          ...
          <Form.Group as={Row} controlId="formPlaintextPassword">
            ...
            <Col sm="4">
              <select className="form-control">
                ...
                <option value="ExpressionofInterst">Expression of Interst</option>
                <option value="SaleTender">Sale Tender</option>
                <option value="RequestforInformation">Request for Information</option>
                <option value="RequestforQuatation">Request for Quatation</option>
                <option value="RegistrationofInterest">Registration of Interest</option>
                <option value="Prequalification">Prequalification</option>
                <option value="AdvancedTenderNotice">Advanced Tender Notice</option>
          ...
          <div className="btnPosition">
            <Button as="input" icon="Search" type="submit" value="Submit"  onSubmit={this.handleSubmitCourse}/>{" "}
