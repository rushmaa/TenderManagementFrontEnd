        ...
        <ReactBootStrap.Navbar collapseOnSelect expand="lg" bg="danger">
          ...
          <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
            <ReactBootStrap.Nav className="mr-auto" color="#fff">
              <ReactBootStrap.Nav.Link href="#features" Component={Link} to="/">HOME</ReactBootStrap.Nav.Link>
            ...
            <ReactBootStrap.Nav>
              <ReactBootStrap.Nav.Link href="#deets" Component={Link} to="/Login">Log In</ReactBootStrap.Nav.Link>
            </ReactBootStrap.Nav>
