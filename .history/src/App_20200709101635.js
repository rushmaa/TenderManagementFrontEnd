  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route exact path="/tenders/E-Lodgement" component={Closed} />
        <Route exact path="/tenders/Closed" component={Newthisweek} />
        <Route exact path="/tenders/New-this-week" component={Elodgement} />
