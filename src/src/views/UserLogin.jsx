        ...
        if (data.user) {
          ...
          if (data.user?.confirmed === "0") {
            ...
            this.setState({
              modal: true,
              message:
                "Please hold on until we confirm your request till to get access to website",
            });
            ...
            this.setState({
              modal: true,
              message:
                "Unfortunately your request has been denied by the admin. Please contact support",
            });
            // history.push('/NoAccess');
            //Rejected
          } else if (data.user?.confirmed === "1") {
      ...
      <div className="App">
        <MDBContainer>
          <MDBModal isOpen={this.state.modal} centered>
            ...
            <MDBModalBody>
              Your request is sent to one of our administrators and will provide
              you access soon.
            </MDBModalBody>
            <MDBModalFooter>
          ...
          >
            <Tabs>
              ...
              <TabPanel>
                ...
                <p>
                  <Link style={{ color: "#000", fontSize: 16 }} to="google.com">
                    Forgot your password?
                  </Link>
                </p>
                <p>
                  <Link style={{ color: "#000", fontSize: 16 }} to="/signup">
                    Sign up here!
                  </Link>
                </p>
              </TabPanel>
