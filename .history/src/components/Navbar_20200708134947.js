        ...
        <ReactBootStrap.Navbar collapseOnSelect expand="lg" bg="danger">
          ...
          <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
            <ReactBootStrap.Nav className="mr-auto" color="#fff">
              <ReactBootStrap.Nav.Link><Link>HOME</Link></ReactBootStrap.Nav.Link>
              <ReactBootStrap.NavDropdown title="TENDERS" id="collasible-nav-dropdown">
                <ReactBootStrap.NavDropdown.Item href="#action/3.1"><Link>Current</Link></ReactBootStrap.NavDropdown.Item>
            ...
            <ReactBootStrap.Nav>
              <ReactBootStrap.Nav.Link href="#deets"><Link to={"/Login"}>Log In</Link></ReactBootStrap.Nav.Link>
            </ReactBootStrap.Nav>
